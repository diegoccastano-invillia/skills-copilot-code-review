...
1. Crie um arquivo para as diretrizes gerais do repositório.
...
1. Crie um arquivo para as diretrizes específicas do frontend.


   > ❗️ **Importante**: Certifique-se de colocar instruções específicas de arquivo na pasta `.github/instructions/`, não na pasta `.github/`.
...
1. Crie um arquivo para as diretrizes específicas do backend.
...
1. Faça commit e push dos arquivos de instrução.
...
1. No VS Code, certifique-se de que as instruções foram realmente commitadas e faça push para o repositório.

1. No navegador, retorne ao pull request criado recentemente.

1. No canto superior direito, encontre o menu **Reviewers** e o botão **Re-request review** ao lado de **Copilot**. Clique nele e aguarde um momento para o Copilot adicionar comentários ao pull request.

   <img width="300" alt="botão de re-revisão" src="https://github.com/user-attachments/assets/c45aa8de-278d-46e7-bfe2-2dc6b574e11e"/>

   > 🦧 **Nota:** Se você for rápido demais após enviar novos commits, talvez precise esperar um pouco para o botão aparecer, ou atualizar a página.

1. Observe que o feedback do Copilot agora é diferente da revisão anterior.

1. Com a revisão solicitada, aguarde um momento para a Mona checar seu trabalho, fornecer feedback e compartilhar a próxima lição.
