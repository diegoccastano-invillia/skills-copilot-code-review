...
1. Inicie um novo pull request. Preencha os detalhes abaixo e clique em **Create pull request**.
...
1. Na área de detalhes à direita, encontre o menu **Reviewers**. Clique no **ícone de configurações** para mostrar a lista de revisores disponíveis e selecione **Copilot**.
...
1. Aguarde um momento para o Copilot revisar as mudanças e adicionar comentários ao seu pull request. Note que uma entrada foi adicionada ao log de conversas.
